...
function base64() {
  let mensagem = document.querySelector("#caixa-msg").value;
...
function cifraCesar() {
  let msg = document.querySelector("#caixa-msg").value;
  let chave = parseInt(document.querySelector("#rngnb").value);
  let saida = '';
